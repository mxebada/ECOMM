...
var React18, import_react, isBrowser2, hasOwn, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, getTheme, createCacheWithTheme, typePropName, labelPropName, Insertion, Emotion;
...
var init_emotion_react_browser_esm = __esm({
  "node_modules/@emotion/react/dist/emotion-react.browser.esm.js"() {
    ...
    Global = withEmotionCache(function(props, cache2) {
      ...
      var serialized = serializeStyles([styles], void 0, React19.useContext(ThemeContext));
      if (!isBrowser2) {
        var _ref;
...
var React20, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, ILLEGAL_ESCAPE_SEQUENCE_ERROR2, Insertion5, createStyled;
      ...
      return function() {
        ...
        var Styled = withEmotionCache(function(props, cache2, ref) {
          ...
          if (props.theme == null) {
            ...
            mergedProps.theme = React20.useContext(ThemeContext);
          }
          if (typeof props.className === "string") {
          ...
          newProps.className = className;
          newProps.ref = ref;
          return React20.createElement(React20.Fragment, null, React20.createElement(Insertion5, {
            cache: cache2,
            serialized,
            isStringTag: typeof FinalTag === "string"
          }), React20.createElement(FinalTag, newProps));
        });
...
var React21, import_prop_types7, import_jsx_runtime3, cache;
var init_StyledEngineProvider = __esm({
  "node_modules/@mui/styled-engine/StyledEngineProvider/StyledEngineProvider.js"() {
    ...
    true ? StyledEngineProvider.propTypes = {
       ...
       */
      injectFirst: import_prop_types7.default.bool
    } : void 0;
  }
});
...
var React22, import_prop_types8, import_jsx_runtime4;
...
function useSlider(parameters) {
  ...
  const [focusedThumbIndex, setFocusedThumbIndex] = React15.useState(-1);
  ...
  const changeValue = (event, valueInput) => {
    ...
    if (range) {
      if (disableSwap) {
        newValue = clamp_default(newValue, values2[index - 1] || -Infinity, values2[index + 1] || Infinity);
      }
...
function RtlProvider(_ref) {
  ...
  return (0, import_jsx_runtime2.jsx)(RtlContext.Provider, _extends({
...
function SliderValueLabel(props) {
  ...
  }, (0, import_jsx_runtime6.jsxs)(React24.Fragment, {
    children: [children.props.children, (0, import_jsx_runtime5.jsx)("span", {
...
var _excluded9 = ["aria-label", "aria-valuetext", "aria-labelledby", "component", "components", "componentsProps", "color", "classes", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "shiftStep", "size", "step", "scale", "slotProps", "slots", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat"];
var useThemeProps3 = createUseThemeProps("MuiSlider");
  ...
  return {
    ...
    variants: [{
      ...
      style: _extends({}, theme.vars ? {
        ...
        backgroundColor: (0, import_colorManipulator2.lighten)(theme.palette[color2].main, 0.62),
        borderColor: (0, import_colorManipulator2.lighten)(theme.palette[color2].main, 0.62)
      }, theme.applyStyles("dark", {
        backgroundColor: (0, import_colorManipulator2.darken)(theme.palette[color2].main, 0.5)
      }), theme.applyStyles("dark", {
        borderColor: (0, import_colorManipulator2.darken)(theme.palette[color2].main, 0.5)
      })))
    }))]
  };
});
    ...
    variants: [{
      ...
      style: {
        [`&:hover, &.${sliderClasses_default.focusVisible}`]: _extends({}, theme.vars ? {
          ...
          boxShadow: `0px 0px 0px 8px ${(0, import_colorManipulator2.alpha)(theme.palette[color2].main, 0.16)}`
        }, {
          "@media (hover: none)": {
            boxShadow: "none"
          }
        ...
        [`&.${sliderClasses_default.active}`]: _extends({}, theme.vars ? {
          ...
          boxShadow: `0px 0px 0px 14px ${(0, import_colorManipulator2.alpha)(theme.palette[color2].main, 0.16)}`
        })
      }
    }))]
  };
...
var Slider = React25.forwardRef(function Slider2(inputProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime7.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime7.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime8.jsxs)(React25.Fragment, {
        children: [(0, import_jsx_runtime7.jsx)(MarkSlot, _extends({
          "data-index": index
        ...
        })), mark.label != null ? (0, import_jsx_runtime7.jsx)(MarkLabelSlot, _extends({
          "aria-hidden": true,
          "data-index": index
      ...
      return (
        ...
        (0, import_jsx_runtime7.jsx)(ValueLabelComponent, _extends({}, !isHostComponent(ValueLabelComponent) && {
          valueLabelFormat,
          valueLabelDisplay,
          ...
          children: (0, import_jsx_runtime7.jsx)(ThumbSlot, _extends({
            "data-index": index
          }, thumbProps, {
            ...
            style: _extends({}, style3, getThumbStyle(index), thumbProps.style),
            children: (0, import_jsx_runtime7.jsx)(InputSlot, _extends({
              "data-index": index,
...
true ? Slider.propTypes = {
   ...
   * @default 10
   */
  shiftStep: import_prop_types10.default.number,
  /**
