...
var Context = (0, import_react9.createContext)(canUseDOM_default ? window : void 0);
...
var useIsomorphicEffect_default = isDOM || isReactNative ? import_react11.useLayoutEffect : import_react11.useEffect;
...
var TransitionWrapper = import_react18.default.forwardRef(({
  ...
  return (0, import_jsx_runtime6.jsx)(Transition_default, {
    ref,
    ...props,
    onEnter: handleEnter,
    onEntered: handleEntered,
...
var Fade = React7.forwardRef(({
  ...
  const handleEnter = (0, import_react19.useCallback)((node, isAppearing) => {
    triggerBrowserReflow(node);
    onEnter == null ? void 0 : onEnter(node, isAppearing);
  }, [onEnter]);
  return (0, import_jsx_runtime7.jsx)(TransitionWrapper_default, {
    ref,
...
var ModalDialog = React10.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var AbstractModalHeader = React13.forwardRef(({
  ...
  const context = (0, import_react20.useContext)(ModalContext_default);
...
var ModalHeader = React14.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var divWithClassName_default = (className) => React15.forwardRef((p, ref) => (0, import_jsx_runtime15.jsx)("div", {
  ...p,
  ref,
...
var ModalTitle = React16.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React17.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react21.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react21.useState)(false);
  const waitingForMouseUpRef = (0, import_react21.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react21.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react21.useRef)(null);
  const [modal, setModalRef] = useCallbackRef();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react21.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react21.useCallback)((backdropProps) => (0, import_jsx_runtime17.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime17.jsx)("div", {
    ...
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime17.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime17.jsx)(ModalContext_default.Provider, {
    value: modalContext,
...
export {
  _objectWithoutPropertiesLoose4 as _objectWithoutPropertiesLoose,
  ownerDocument,
  css_default,
  require_prop_types,
  EXITED,
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-SA6E4JUO.js.map
